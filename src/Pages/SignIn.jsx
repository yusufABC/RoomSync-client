            ...
            <div className="mx-auto my-20 w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" id="username" placeholder="email" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-orange-600" />
                    </div>
                    <div className="space-y-1 text-sm">
                    ...
                    <button type='submit' className="block w-full p-3 text-center rounded-sm text-gray-50 bg-orange-600">Sign in</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 text-gray-600">Don't have an account?
                    <NavLink to='/signup' rel="noopener noreferrer" href="#" className="underline text-yellow-600">Sign up</NavLink>
                </p>
