...
const Signup = () => {
    ...
    return (
              <div className="my-20 mx-auto w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-100 text-gray-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1 text-sm">
                ...
                <input type="text" name="photourl" id="photoUrl" placeholder="Email" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-orange-600" />
            </div>
            <div className="space-y-1 text-sm">
            ...
            <button type='submit' className="cursor-pointer block w-full p-3 text-center rounded-sm text-gray-50 bg-gray-300">Sign in</button>
        </form>
        ...
        <p className="text-xs text-center sm:px-6 text-gray-600">Alreadey have an account?
            <NavLink to="/signin" rel="noopener noreferrer" href="#" className="underline text-gray-800">Sign in</NavLink>
        </p>
